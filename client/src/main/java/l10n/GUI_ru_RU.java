...
public class GUI_ru_RU extends ListResourceBundle {
    ...
    protected Object[][] getContents() {
        return new Object[][]{
                ...
                {"synopsis.text", """
                                      Инструкция по фильтрации и сортировке
                                            таблицы:
                                        Для сортировки по возрастанию
                                        кликните один раз по заголовку
                                        нужного столбца
                                        По убыванию - 2 раза.
                                        Для фильтрации введите в поле
                                        фильтрации одно булево выражение
                                        на языке JavaScript, используя
                                        операторы сравнения (==, !=, < и тд),
                                        логические оераторы (&&, ||) и
                                        функции (name.length, sum(x, y) и тд).
                                        Например: id > 3000 && owner == 'user'.
                                        ВНИМАНИЕ: Приложение на момент версии
                                        3.2.x не поддерживает фильтрацию по дате."""},
