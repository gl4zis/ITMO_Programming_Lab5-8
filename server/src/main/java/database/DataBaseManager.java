...
public class DataBaseManager {
     ...
     * @throws SQLException            if something went wrong with connection
     */
    public synchronized void addUser(User user) throws LoginCollisionException, SQLException {
     ...
     * @throws SQLException if something went wrong with connection
     */
    public synchronized void clearDragons(User user) throws SQLException {
     ...
     */
    public synchronized void removeById(int id, User user) throws SQLException, PermissionDeniedException {
        String login = user.getLogin();
     ...
     */
    public synchronized void updateDragon(int id, Dragon newDragon, User user)
     ...
     * @throws SQLException if something went wrong with connection
     */
    public synchronized void changePasswd(User user, String newPasswd) throws SQLException {
